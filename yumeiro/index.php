	...
	<img class="faerie" src="/wp-content/themes/yumeiro/images/faerie.png" />
        ...
        <? } else { // if we have posts ?>
            ...
            <? } ?>
				...
				<div class="post-end">
					<span class="permalink"><img class="permalink-image" src="images/permalink.png" /> <a href="<? the_permalink(); ?>">Permalink</a></span>
					<? if ($is_list) { // just a comment link ?>
                    <span class="comments-link">
                        <img class="comments-image" src="images/comments.png" /> <?php comments_popup_link( '<span class="leave-reply">' . __( 'Reply', 'yumeiro' ) . '</span>', _x( '1', 'comments number', 'yumeiro' ), _x( '%', 'comments number', 'yumeiro' ) ); ?>
                    </span>
